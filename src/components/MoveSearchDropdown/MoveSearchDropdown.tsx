...
function MoveSearchDropdown({
  ...
  return (
    <div
      ...
      className={`${className} absolute z-50 top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg pr-1 py-1.5
      `}
    >
      <div
        className="w-full overflow-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-400"
        style={{
